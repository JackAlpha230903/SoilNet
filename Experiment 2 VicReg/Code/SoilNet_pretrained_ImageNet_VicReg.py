...
checkpoint_path = '/content/drive/MyDrive/SoilNet_Checkpoints/Soilnet_pretrained_ImageNet.pth'
try:
...
checkpoint_dir = "/content/drive/MyDrive/SoilNet_Checkpoints/checkpoints_VicReg_IMAGENET"
